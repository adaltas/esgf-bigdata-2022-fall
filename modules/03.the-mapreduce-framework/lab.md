...
1. Clone the repo [esgf-bigdata-2022-fall](https://github.com/adaltas/esgf-bigdata-2022-fall.git) in your home on the edge node:
   ```bash
   git clone https://github.com/adaltas/esgf-bigdata-2022-fall.git
   ```
...
4. Take a look at the input we will use for the MapReduce in HDFS at `/education/esgf_2022_fall_bda_1/resources/lab3/mapred-input`
5. The following command will run a MapReduce with 2 reducers, so it will produce 2 output files:
   ...
   mapred streaming -D mapreduce.job.reduces=2 \
     ...
     -input /education/esgf_2022_fall_bda_1/resources/lab3/mapred-input \
     -output /education/esgf_2022_fall_bda_1/$USER/lab3/word-count \
     -mapper "python3 mapper.py" -reducer "python3 reducer.py"
   ```
6. Check the output at `/education/esgf_2022_fall_bda_1/$USER/lab3/word-count`
